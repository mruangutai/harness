...
denials across every write route and T-14's main_session.writes exclusion. Issue #1304's
claim-set guard, which shared this section but not this surface, is
test-check-domain-claims.py. Shared fixtures and the block driver live in
check_domain_support.py.
"""
