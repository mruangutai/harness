...
post-fix command: python3 .claude/skills/harness/bin/run-unit-tests.py --kind all, with concurrent live feature_schema.py polling
post-fix exit 0
...
```text
python3 .claude/skills/harness/bin/run-unit-tests.py --kind all
```
