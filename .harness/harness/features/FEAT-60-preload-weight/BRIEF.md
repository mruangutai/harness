...
| Sum of preload across all 16 agents, words | 99,672 | ≤ 65,000 | 86,680 → 56,953 (the baseline column used a different counter; the tool's whitespace count is the record from here) |
