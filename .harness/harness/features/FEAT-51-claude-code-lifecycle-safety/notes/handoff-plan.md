...
- F-A is real: `agent_type: harness-pm`, no live claim, `cp /tmp/evil.md <feature>/BRIEF.md` exits 0 at `bash-write-guard.py`, `plan-sign-gate.py` AND `check-domain.py` — I fired all three payloads myself — verified-at 0bc57c88
