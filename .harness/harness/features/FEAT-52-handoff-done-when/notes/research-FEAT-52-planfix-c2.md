# Plan fix c2 — FEAT-52: every criterion can now fail
...
real FEAT-52 range the diff arm is 0 lines and BOTH `comm` arms are empty. SC-11 is therefore not
