# Plan fix c1 — FEAT-52 — the criteria now bind
...
`lanes:` rows: `features/FEAT-52-handoff-done-when/notes/handoff-plan.md`,
`notes/mutation-FEAT-52-shared-module.md` (both resolve to `harness-orchestrator`, which hosts rather
