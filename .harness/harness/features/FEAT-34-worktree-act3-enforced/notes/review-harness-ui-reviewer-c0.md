...
DESIGN.md in the diff. Surface is shell (`check-state.py`, `post-merge-sweep.py`,
...
text added to `check-state.py` and the `post-merge-sweep.py` stdout messages. Both are
