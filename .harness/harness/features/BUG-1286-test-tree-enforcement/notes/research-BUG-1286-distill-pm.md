...
`check-expertise.py:20` names displacement as the intended operation.
...
Verification: `check-expertise.py` exit **0** on both files (craft carries its pre-existing P-01
