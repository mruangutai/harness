...
- 2026-08-25: FEAT-40 — post-merge-sweep.py:192 greps ship's combined output for the literal `gh-sync: SKIP`; any new gh-sync line carrying that substring silently changes worktree-removal behaviour. Check that gate before pinning any new output string in gh-sync.py.
