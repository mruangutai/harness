...
- 2026-09-05: BUG-1306 — check-state.py INV-35 is line-based and misreads a multi-line single-quoted YAML flow scalar as an unquoted one; plan.yaml:112's ` #1103` parses intact under safe_load. Verified before treating the red gate as work, which would have meant editing an approval-gated file for nothing.
