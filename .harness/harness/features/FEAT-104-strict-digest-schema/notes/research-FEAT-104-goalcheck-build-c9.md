...
| REQ-02 | met | creation floor `check-domain.py:1586,1608` (`schema_version floor`), step check `:1653-1658`; T-06 `verify:` (`plan.yaml:443-449`) |
...
| REQ-05 | met | digest refusal names every key + route `validate-digest.py:1411-1423`; step refusal names every key + route `check-domain.py:1653-1658` |
