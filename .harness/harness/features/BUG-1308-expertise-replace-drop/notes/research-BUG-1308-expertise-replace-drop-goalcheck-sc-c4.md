...
| SC-08 | **MET** | automated / integration | integration file; probe | case11/case12/case19 `check-expertise.py` exit 0; probe re-ran the checker on its own replace- and drop-produced files, exit 0 both |
