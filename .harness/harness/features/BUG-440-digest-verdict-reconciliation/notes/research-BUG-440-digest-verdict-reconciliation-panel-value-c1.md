...
reader_coverage_note: 'This panel ran two steps: should-not-exist and scope. INV-32 (check-state.sh:534-547)
  expects three readers - should-not-exist, scope and goalcheck - once a plan is approved. The goalcheck
  reading DID happen for this plan, outside the panel team, as notes/research-BUG-440-digest-verdict-reconciliation-goalcheck-plan-c1.md,
  but the validator lead recorded two readers and this transcription records exactly what the lead recorded.
  If it is signed as-is, INV-32 will report goalcheck as unrecorded.'
findings:
