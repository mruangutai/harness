...
- 2026-08-23: a lane argument from "it is the blocking qa gate's runner" was wrong for
  run-unit-tests.py. DEC-174 am.4's rule fires on the DAY a script's gate status changes; adding a
  basename to UNIT_SCRIPTS changes nothing, and check-domain.py --resolve already answered
