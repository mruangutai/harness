...
`git diff --stat dca2d3d..HEAD`: 5 files — `bash-write-guard.sh` (+1), `check-domain.py` (+9/-2),
...
Confirmed via `git diff dca2d3d..HEAD -- bash-write-guard.sh check-domain.py | grep 'def feature_checkout_guard'`
