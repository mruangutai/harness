...
| 4 route completeness | `bash-write-guard.sh:711-722`, `check-domain.py:727-741` | both call `harness_boundary.worktree_for_feature` and both catch `AmbiguousWorktree` |
