...
DIGEST:
  ...
  must_fix:
    ...
    - "F-PP2 (T-03, D-03/D-04, REQ-03): the worktree-binding narrowing is added to check-domain.py only; bash-write-guard.sh's separate classify() call keeps today's unbound behavior for Bash writes, undisclosed."
  spec_violations:
