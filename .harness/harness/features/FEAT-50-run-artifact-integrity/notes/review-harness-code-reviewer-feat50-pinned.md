...
| REQ-05, SC-08/SC-09 | MET | `check-state.py` and `run-unit-tests.py` absent from the diff (untouched). `def case_inv32` present; `test-run-unit-tests-kinds.py` ran green (23/23). |
