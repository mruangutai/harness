...
- The cap refusal keeps the whole-file threshold at 60 and names all five content categories (`check-domain.py:1547-1559`). Focused test inspection shows 60 lines allowed and 61 refused, with no per-section cap (`test-check-domain.py:4211-4223`; `test-check-state.py:2244-2258`).
