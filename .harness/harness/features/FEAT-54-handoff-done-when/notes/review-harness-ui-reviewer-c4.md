...
3. `.claude/skills/harness/bin/check-state.py`
...
- **State findings:** `check-state.py:1069-1070,1188-1264` distinguishes missing narrative headings, the baseline-conditioned fifth heading, block-shape/grammar failures, and the whole-file cap without re-resolving targets. Messages identify the feature/note and remedy. No ANSI or colour-only encoding appears in the reviewed terminal paths.
