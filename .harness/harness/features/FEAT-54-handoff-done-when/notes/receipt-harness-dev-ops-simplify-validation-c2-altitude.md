...
- Hook-specific Edit reconstruction remains in `check-domain.py`, where complete tool payload and pre/post route semantics are available; pushing it into the handoff validator would couple a document module to one editor protocol.
