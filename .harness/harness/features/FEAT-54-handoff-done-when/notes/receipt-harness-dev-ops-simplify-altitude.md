...
One seam-placement finding: the new shared validator earns its depth and is exercised through its public interface, but `check-domain.py` retains a second authority for whether `## Done when` exists.
