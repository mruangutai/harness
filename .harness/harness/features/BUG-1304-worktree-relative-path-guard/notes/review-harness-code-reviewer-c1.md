...
Write/Edit route (`check-domain.py`) reaches `claim_checkout_guard` at exactly two call sites,
...
narrow (grepped: no `\.claude/worktrees/` shortcut exists in check-domain.py) — this asymmetry is
