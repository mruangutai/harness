...
- SC-06: the named program is integration-only in the runner and represented in the integration configuration; this is exercised by the passing kind cross-check (`run-unit-tests.py:17-18,84-127`).
