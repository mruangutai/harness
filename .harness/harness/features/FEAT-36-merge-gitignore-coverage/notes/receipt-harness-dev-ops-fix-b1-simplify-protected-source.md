...
| --- | --- | --- | --- |
| SHA-256 | `shasum -a 256 .agents/skills/harness/bin/merge-gitignore.py` | `86cfff73c88a2baa1c74d2e516e3608e38954fef1c9e4ef344113b011e425c12` | Matches QA-recorded value exactly |
| Worktree diff | `git diff --quiet -- .agents/skills/harness/bin/merge-gitignore.py` | exit `0` | No diff for protected path |
