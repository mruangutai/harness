...
- Relevant unchanged utility: `.agents/skills/harness/bin/merge-gitignore.py` — inspected to trace the process and filesystem contract; the pinned diff does not modify it.
