...
copied from — plus `check-domain.py:152/:296`, `bash-write-guard.py:194/:232`,
`validate-digest.py:821/:913`). Seven are not, and one of those, `inject-expertise.py:31`, is a
