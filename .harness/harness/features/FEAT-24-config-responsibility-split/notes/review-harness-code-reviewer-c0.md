...
**2. Full suite at the pin** (`run-unit-tests.py --kind all`, worktree at `14994b3`):
- `ok`/`PASS` lines: **1578**
- `FAIL` lines: **0**
- exit code: **0**
...
`branch-create-gate.py`, `check-plan-routes.py`, `run-unit-tests.py` are byte-identical between
