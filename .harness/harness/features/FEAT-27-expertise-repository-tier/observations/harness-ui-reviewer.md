...
- 2026-08-19: diff b4659cd..9b929de is a 57-file, no-rendered-UI, no-DESIGN.md diff (measured:
  ...
  Dispatch named an adjacent non-rendered surface (inject-expertise.py's header/precedence text,
  check-expertise.py's advisory line) as in-remit per P-06 — worth the look: found a real, low-severity
