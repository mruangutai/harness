...
T-02 `d8a99991` (`.claude/skills/harness/bin/check-domain.py`, new `_checkout_root` sibling helper
...
live adjacent defect of the same class found OUTSIDE the diff at `check-domain.py:1472-1474`
