...
`INTEGRATION_SCRIPTS`) in `.claude/skills/harness/bin/run-unit-tests.py`. All remaining
...
## Change
- `run-unit-tests.py` line 30/31: deleted exactly the three names, kept every other entry
