...
| **D-05** (carve-out extension) | **kept — user-confirmed (Q5), not re-litigated** | `bin/test-check-state.py`, `bin/run-unit-tests.py`, `bin/test-team-catalog.py` stay main-session-direct. |
