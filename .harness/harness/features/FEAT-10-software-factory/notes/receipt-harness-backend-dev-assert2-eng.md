...
`bash .claude/skills/harness/bin/run-unit-tests.py` → exit 0 (87 `PASS ` lines total in the
...
`bash .claude/skills/harness/bin/run-unit-tests.py` → **exit 0**; 87 `PASS ` lines in the combined
