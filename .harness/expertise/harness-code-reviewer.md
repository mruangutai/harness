...
- P-08: WHEN a peer reviewer (e.g. security) has cleared a shared mechanism DO still evaluate it against your own review question before treating it settled — the same fact (a glob's character class) can correctly answer their question while failing yours; the gap lives in the union neither alone would see.
