...
- P-04: WHEN a diff only deletes CLI/terminal output DO rule it out of scope with explicit stated reasons (no markup/styling/a11y tree, no contract to diverge from, deletion not build) rather than silently defaulting to skip.
