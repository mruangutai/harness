...
- **Step zero, BLOCKING:** `/harness-grill` first (skill `harness-grilling`) — dialog to clarity
  ...
  **path** as a BRIEF input (DEC-164). Already have a grilling artifact for this idea? Cite it and
  move on. Skipping it is the user's explicit call, never your assumption.
