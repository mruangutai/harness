...
description: Validation lead — runs the reviewer panel, assesses and synthesizes its findings into one actionable set, and is the independence layer over qa. Conducts review-team. Use when the question is whether work is correct, tested, safe and visually faithful.
