...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: ${CLAUDE_PROJECT_DIR}/.claude/skills/harness/bin/check-domain.sh harness-frontend-dev
---
...
`.harness/DESIGN.md` is the authority — palette, type scale, spacing, component direction, light/dark.
