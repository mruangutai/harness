# Code-risk examples — thresholds, shapes that lift a grade, and graded samples

Read this when a grade from `code-grade.py` surprises you, or when a function is below the bar and
you want the shape that raises it. The rules — the bar, what blocks, when a reason is required —
are `harness-code-risk-grading`; this file is the worked material behind them.
