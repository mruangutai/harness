# Archived from CLAUDE.md (DEC-135) — the April 2026 GSD-era stack analysis

> Historical. Written when GSD was the intended backbone; GSD was uninstalled 2026-07-26
> and the harness became self-hosting. Kept for the research citations only.
