...
| 24 | **GitHub Issues integration** — feature→milestone, tasks→issues | pending — design under discussion (direction of truth, sync trigger, executor). kaya-ai tracks milestones/tasks in Issues, mirroring FEAT→T-NN. Prereq for 17 only if we want the first kaya feature mirrored from day one |
